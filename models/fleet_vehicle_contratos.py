...
class FleetVehicleLogContract(models.Model):
    ...
    documentos_ids = fields.Many2many(
        ...
        relation='fleet_vehicle_contract_attachment_rel',
        column1='contract_id',
        ...
        for rec in self:
            if rec.vehicle_id:
              ...
              trabajo_det = rec.env['fleet.vehicle.work'].search(
                  [('state', '=', 'activo'),('detalle_ids.vehicle_id.id', '=', rec.vehicle_id.id)],
