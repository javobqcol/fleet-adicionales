...
class FleetVehicleLogFuel(models.Model):
    ...
    def default_get(self, default_fields):
        ...
        service = self.env.ref(
            'fleet-adicionales.type_service_refueling',
    ...
    documentos_ids = fields.Many2many(
        ...
        relation='fleet_vehicle_fuel_log_attachment_rel',
        column1='service_id',
        column2='attachment_id',
        string='Documentos servicio'
    )
    calculo = fields.Float(
        compute='_gasto_combustible',
        string='Calculo',
        store=True
    )
